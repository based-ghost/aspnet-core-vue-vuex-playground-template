...
namespace GhostUI.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddResponseCompression_Gzip(this IServiceCollection services, IEnumerable<string> mimeTypes, CompressionLevel compressionLvl, bool enableForHttps = true)
        {
