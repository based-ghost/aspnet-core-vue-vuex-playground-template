              ...
              <div class="column dashboard-info is-half">
                <div class="content">
                  <ul>
                    ...
                    <li>
                      <a
                        class="dashboard-link typescript"
                        target="_blank"
                        rel="noopener noreferrer"
